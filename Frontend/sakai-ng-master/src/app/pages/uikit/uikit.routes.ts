...
export default [
    ...
    { path: 'organization', data: { breadcrumb: 'Organization' }, component: Organization },
    { path: 'addOrganizationType', data: { breadcrumb: 'AddOrganizationType' }, component: AddOrganizationType },
